...
<%
    ...
    try {
        ...
        // fetch recipe data where difficulty is 1
        String sql = "SELECT * FROM recipe WHERE difficulty = 1";
...
<div class="titleBox">
    ...
    <div class="icon2" onclick="location.href='./recipesave.html';"><span class="material-symbols-outlined"
                                                                          style="color : red;">edit</span></div>
</div>
<div class="pageTitle"><h1>초급 요리</h1></div>
<div>
    <div class="tableBox">
